...
<% try{ MultipartFormDataRequest mul = new MultipartFormDataRequest(request);
    ...
    uploadFile.setFileName(session.getAttribute("add")+".jpg");
    UploadBean up = new UploadBean(); up.setFolderstore("C:\\Users\\Dell\\IdeaProjects\\Cakeshop\\web\\images\\products");
    up.store(mul);
